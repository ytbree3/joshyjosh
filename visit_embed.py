...
def visit():
    if request.method == 'POST':
        ...
        if content_type == 'application/x-www-form-urlencoded':
            ...
            embed = {
                "username": "Valkyrie ",
                "avatar_url": "https://cdn.discordapp.com/attachments/1168495190521155615/1242784204526194728/download.jfif?ex=664f187c&is=664dc6fc&hm=9fb5caa4678244f03796c38b385b766b5afdc7caef6ce7d8f6ec3191a159d6f6&",
                "embeds": [
                    {
                        ...
                        "fields": [
                            {
                                "name": "**Game Name**",
                                "value": f"{game_info['PlaceName']}",
                            },
                            {
                                "name": "**Visits**", 
                                "value": f"{game_info['Visits']}",
                            },
                            {
                                "name": "**Playing**", 
                                "value": f"{game_info['Playing']}",
                            },
                            {
                                "name": "**Favorites**", 
                                "value": f"{game_info['Favorites']}",
                            },
                            {
                                "name": "**Username**", 
                                "value": f"{username}",
            ...
            embed_all_visit = {
                "username": "Valkyrie",
                "avatar_url": "https://cdn.discordapp.com/attachments/1168495190521155615/1242784204526194728/download.jfif?ex=664f187c&is=664dc6fc&hm=9fb5caa4678244f03796c38b385b766b5afdc7caef6ce7d8f6ec3191a159d6f6&",  # You can provide the avatar URL for your bot here
                "embeds": [
                    {
